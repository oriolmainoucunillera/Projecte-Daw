    ...
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                    ...
                    <form class="form-inline my-2 my-lg-0" action="buscador" enctype="multipart/form-data" method="get">
                        <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="buscador" id="buscador">
        ...
        <nav class="footer">
            <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm justify-content-center">
                <a href="https://www.instagram.com" target="_blank"><img src="insta.png" class="img-fluid p-3" alt="instagram" width="80px"></a>
                <a href="https://www.facebook.com" target="_blank"><img src="face.png" class="img-fluid p-3" alt="facebook" width="80px"></a>
                <a href="https://www.youtube.com" target="_blank"><img src="youtube.png" class="img-fluid p-3" alt="youtube" width="80px"></a>
                <a href="https://twitter.com/explore" target="_blank"><img src="twitter.png" class="img-fluid p-3" alt="twitter" width="80px"></a>
            </nav>
        </nav>
    </div>
